...
class HttpClientTest {
    ...
    async testCORSAccess() {
        const btn = document.getElementById('cors-test-btn');
    ...
    async testDictionaryLookup(langSlug) {
    ...
    async testVerbForms() {
        ...
        const btn = document.getElementById('verb-btn');
    ...
    async lookupWordInCambridge(word, langSlug) {
