 ...
 */
class DebugHelper {
    private static logger = new Logger('DebugHelper');
    private static mockAuth: MockAuth | null = null;
     ...
     */
    private static addDebugControls(): void {
     ...
     */
    private static setupDebugEventListeners(): void {
     ...
     * Setup global debug functions
     */
    private static setupGlobalDebugFunctions(): void {
     ...
     */
    private static toggleAuthState(): void {
     ...
     */
    private static showAuthInfo(): void {
     ...
     * Show mock data
     */
    private static showMockData(): void {
        const mockData = {
    ...
    private static simulateError(): void {
        ...
        const error = errors[randomError as keyof typeof errors];
     ...
     */
    private static performanceTest(): void {
     ...
     */
    private static exportLogs(): void {
